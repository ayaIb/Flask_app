...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Techno Shield\PycharmProjects\flask_test.py\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Techno Shield\PycharmProjects\flask_test.py\venv\Scripts\deactivate.nu'
